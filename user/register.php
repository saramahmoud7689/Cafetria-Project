                        ...
                        <form id="registerForm" action="register_process.php" method="POST"
                            ...
                            <div class="mb-2">
                                ...
                                <div id="confirmPasswordError" class="error-message">
                                    <?php if (isset($_GET['confirm_password_error']))
                                        echo htmlspecialchars($_GET['confirm_password_error']); ?>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <div id="roomError" class="error-message">
                                    <?php if (isset($_GET['room_error']))
                                        echo htmlspecialchars($_GET['room_error']); ?>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <div id="profilePictureError" class="error-message">
                                    <?php if (isset($_GET['profile_picture_error']))
                                        echo htmlspecialchars($_GET['profile_picture_error']); ?>
                                </div>
                            </div>
